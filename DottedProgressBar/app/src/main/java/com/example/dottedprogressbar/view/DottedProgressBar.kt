package com.example.dottedprogressbar.view
...
import com.example.dottedprogressbar.view.setting.ProgressBarSettings
import com.example.dottedprogressbar.view.setting.StatusDottedProgressBar
...
class DottedProgressBar @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null) :
    ...
    private fun setAttribute(attrs: AttributeSet) {
        ...
        progressEmptyColor = typArray.getColor(R.styleable.DottedProgressBar_progress_empty_Color,
            DEFAULT_COLOR_EMPTY)
        progressFullColor = typArray.getColor(R.styleable.DottedProgressBar_progress_full_Color,
            DEFAULT_COLOR_FULL)
        progressSize = typArray.getInt(R.styleable.DottedProgressBar_progress_size,
